	...
	\item	Soldering by hand:
		\begin{itemize}
			...
			\item	Some devices (SOIC?) have slightly bendy pins. A small amount of downwards 
				pressure on the pin onto a tinned pad can work.
		\end{itemize}
\end{itemize}
...
On the host pc, custom software will have to be written to translate the design into a gcode file to be sent to the machine.
