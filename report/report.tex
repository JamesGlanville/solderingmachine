...
that is dependent on the position of a potentiometer. The 50Hz wave satisfies the condition of pulses that should be sent every ~20ms, and the pulses are varied between 1-2ms. The speed controllers
