...
\begin{itemize} \itemsep0em
	...
	\item	CNC: Computer numerical control. Refers to the automation of machine tools with programmed commands.
	\item	GCODE: A human-readable numerical control programming language, commonly used in CNC machines.
\end{itemize}
