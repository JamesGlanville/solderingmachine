...
The machine performed acceptably during solder paste extrusion. 
...
In its current state the machine does not present many clear advantages over
more manual methods of PCB manufacture, but given more development time
and testing this is expected to improve.
